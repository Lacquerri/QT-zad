...
public:
    ...
    void setupUi(QMainWindow *obrazki)
    {
        ...
        lineEditKom->setObjectName(QString::fromUtf8("lineEditKom"));
        lineEditKom->setGeometry(QRect(360, 550, 211, 24));
        lineEditSciezka = new QLineEdit(centralwidget);
        lineEditSciezka->setObjectName(QString::fromUtf8("lineEditSciezka"));
