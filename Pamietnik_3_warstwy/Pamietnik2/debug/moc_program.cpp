...
static constexpr auto qt_meta_stringdata_CLASSProgramENDCLASS = QtMocHelpers::stringData(
    "Program",
    "odswiezOkna",
    "",
    "signalDarkmode",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSProgramENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSProgramENDCLASS_t qt_meta_stringdata_CLASSProgramENDCLASS = {
    {
        QT_MOC_LITERAL(0, 7),  // "Program"
        QT_MOC_LITERAL(8, 11),  // "odswiezOkna"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 14),  // "signalDarkmode"
        QT_MOC_LITERAL(36, 14),  // "stworzonoKopie"
        QT_MOC_LITERAL(51, 13)   // "przywrocKopie"
    },
    "Program",
    "odswiezOkna",
    "",
...
Q_CONSTINIT const QMetaObject Program::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSProgramENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<QString, std::false_type>,
        QtPrivate::TypeAndForceComplete<QString, std::false_type>,
        // method 'signalDarkmode'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<bool, std::false_type>,
        // method 'stworzonoKopie'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<bool, std::false_type>,
        // method 'przywrocKopie'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<bool, std::false_type>
    >,
    nullptr
...
void Program::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->signalDarkmode((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 2: _t->stworzonoKopie((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 3: _t->przywrocKopie((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Program::odswiezOkna; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &Program::signalDarkmode; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Program::*)(bool );
            if (_t _q_method = &Program::stworzonoKopie; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Program::*)(bool );
            if (_t _q_method = &Program::przywrocKopie; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
